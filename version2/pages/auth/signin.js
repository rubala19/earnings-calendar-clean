...
// FIX #9: Removed debug console.log statements that leaked auth provider
// configuration info in production.
    ...
    <div className="signin-container">
      <div className="signin-card">
        ...
        <div className="signin-footer">
          <p>Your events will be saved and synced across devices</p>
        </div>
      </div>
    </div>
  );
